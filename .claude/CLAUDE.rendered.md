<!--
  GENERATED FILE — DO NOT EDIT, AND DO NOT @-IMPORT THIS FILE.
  Flattened, human-readable view of the effective global ruleset.
  Source: CLAUDE.md + rules/. Regenerate with .claude/render-rules.sh
  (this also runs automatically via the pre-commit hook).
-->
